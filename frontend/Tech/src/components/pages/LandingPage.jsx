        ...
        <section className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3 mb-16 font-merriweather">
          ...
          <Card className="bg-card text-card-foreground">
            <CardHeader>
              ...
              <CardTitle className="text-primary">Système de Tickets</CardTitle>
              <CardDescription className="text-muted-foreground">
          ...
          <Card className="bg-card text-card-foreground">
            <CardHeader>
              ...
              <CardDescription className="text-muted-foreground">Suite complète d'outils IT</CardDescription>
            </CardHeader>
            <CardContent>
              <p>
            ...
            <CardFooter>
              <Button variant="outline" className="text-primary hover:bg-primary hover:text-primary-foreground">Explorer</Button>
            </CardFooter>
          </Card>
        </section>
