            ...
            <main className="container mx-auto px-4 py-12">
                <section className="text-center mb-16">
                    ...
                    <p className="text-xl text-muted-foreground mb-8">
                        Plateforme d'outils et d'automatisation pour simplifier nos tâches quotidiennes.
                    </p>
                    <Button size="lg">
                ...
                <section className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3 mb-16">
                    <Card>
                        <CardHeader>
                            ...
                            <CardDescription>Assistance à distance rapide et sécurisée</CardDescription>
                        </CardHeader>
                        <CardContent>
                    ...
                    <Card>
                        ...
                        <CardContent>
                            <p>Centralisez et suivez toutes les demandes d'assistance de manière organisée.</p>
                        </CardContent>
                        <CardFooter>
                            <Button variant="outline">Accéder</Button>
                        </CardFooter>
                    ...
                    <Card>
                        ...
                        <CardContent>
                            <p>Découvrez notre gamme d'outils spécialisés pour optimiser votre travail.</p>
                        </CardContent>
                        <CardFooter>
